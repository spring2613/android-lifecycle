 ...
 */
public class CompatAActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.mBtn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(CompatAActivity.this, CompatBActivity.class));
            }
        });
        ...
        findViewById(R.id.mBtnAdd).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getSupportFragmentManager().beginTransaction()
                        .add(android.R.id.content, new CompatBFragment())
                        .commit();
            }
        });

        findViewById(R.id.mBtnReplace).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getSupportFragmentManager().beginTransaction()
                        .replace(android.R.id.content, new CompatCFragment())
                        .commit();
            }
        });

        findViewById(R.id.mBtnRemove).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getSupportFragmentManager().beginTransaction()
                        .remove(getSupportFragmentManager().findFragmentById(android.R.id.content))
                        .commit();
            }
        });
